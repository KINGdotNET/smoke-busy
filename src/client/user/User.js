...
export default class User extends React.Component {
  ...
  render() {
    ...
    const busyHost = global.postOrigin || 'https://smoke.io';
    ...
    const title = `${displayedUsername} - Smoke`;
    ...
    return (
      <div className="main-panel">
        <Helmet>
          ...
          <meta property="og:site_name" content="Smoke" />

          <meta property="twitter:card" content={image ? 'summary_large_image' : 'summary'} />
          <meta property="twitter:site" content={'@smoke_io'} />
          <meta property="twitter:title" content={title} />
          <meta property="twitter:description" content={desc} />
          <meta
            property="twitter:image"
            content={image || 'https://smoke.network/assets/images/twshare.png'}
          />
        </Helmet>
        <ScrollToTopOnMount />
        {user && (
